...
namespace RustBestSpot
{
    public partial class Main : Form
    {
        ...
        private void Main_Resize(object sender, EventArgs e)
        {
            ...
            pictureBox1.Width = formWidth - (115 * 2);
        ...
        private void Processing(bool Working = false)
        {
            if (Working)
            {
        ...
        public void MatchTest(float přesnost, Bitmap ImageSource, Bitmap TeplateSource, string name = "null")
        {
            ...
            for (int y = 0; y < Matches.Data.GetLength(0); y++)
            {
                ...
                {
                    if (Matches.Data[y, x, 0] >= přesnost)
                    {
                        if (ImageSource.GetPixel(x, y) == TeplateSource.GetPixel(0, 0))
                        {
                            matchCounter++;
        ...
        private Point pointCorrection(Point input)
        {
        ...
        private void BestSpotCalculation()
        {
        ...
        private void pointValueCalculate(Point position)
        {
